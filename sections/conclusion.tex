...
\chameleon{} currently works with the Haskell language, but in future we plan to extend the typechecking system to work with other strongly typed languages, such as Rust or TypeScript.