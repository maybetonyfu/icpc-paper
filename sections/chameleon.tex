...
\begin{figure*}
    ...
    \caption{
        ...
        %debugging pane on the right. 
        The editor pane (left) is similar to a
...
Internally, deduction steps are different ways to group the error locations into two highlighted colors. If all the highlights are placed in a list-like data structure, each increment of the step numbers moves the end of one color and the start of the other forward (Fig.~\ref{fig:step-interface} right).
