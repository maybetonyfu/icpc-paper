...
\begin{figure}[h]
    \centering
    \Description{Comparing Chameleon with \chameleon{}}
...
\begin{figure}[h]
    \centering
    \Description{An anatomy of \chameleon{} interface}
...
\begin{figure}[h]
    \centering
    \Description{Using \chameleon{} Type Compare Tool}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\linewidth}
        \centering
        \Description{Using \chameleon{} Candidate Expression Cards}
    ...
    \begin{subfigure}[b]{\linewidth}
        \centering
        \Description{Using \chameleon{} Deduction Steps}
...
\begin{figure}[h]
    \centering
    \Description{Showing an type error with a single candidate}
