...
After reading the error reports, Maxine realizes that the error possibly revolves 
...
Maxine writes additional code to add only even numbers in a list of integers, reusing the \texttt{sum} function she wrote
...
mode, she has access to the debugging steps and the explanation layer. 
