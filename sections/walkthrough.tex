...
\begin{figure}[h]
        \centering
        \Description{Maxine using basic mode}
...
\begin{figure}[h]
        \centering
        \Description{A screenshot of using basic mode}
...
\begin{figure}
        \centering
        \Description{A screenshot of using balanced mode}
...
\begin{figure}
        ...
        \Description{A screenshot of using advanced mode}
        \caption{
            Maxine's code to calculate only the sum 
